...
packageList="epel-release rsyslog git socat fail2ban zip net-tools htop e2fsprogs ufw rkhunter debsums chkrootkit rbash iptables-persistent iptables-services clamav clamav-daemon"
